...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  // --- MODAL BOTTOM SHEET (TUGAS DEV UI) --- //
          ...
          children: [
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    const Text('Sisa Uang Saku Saat Ini', style: TextStyle(color: Colors.white700, fontSize: 14)),
                    ...
                    TextButton.icon(
                      ...
                      label: const Text('Isi Uang Saku (+Rp50.000)', style: TextStyle(color: Colors.white)),
                    ),
                  ],
                ),
              ),
