...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  // (Pada branch ui-form, logika ini masih menempel di sini sebelum digabung dengan pekerjaan Dev Logic)
  ...
  // 4. Modal Bottom Sheet Form Input (UI Modern) - Tugas Utama Dev UI
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start, // Mengikuti UI Standar
          children: [
            const Text(
              'Tambah Pengeluaran',
          ...
          children: [
            ...
            Expanded(
              child: _riwayatPengeluaran.isEmpty
                  ? const Center(
                      child: Text('Belum ada pengeluaran hari ini. Hemat banget! 🎉'),
                    )
                  : ListView.builder(
